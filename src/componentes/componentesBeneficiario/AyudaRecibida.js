            ...
            <CardContent>
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <Typography variant="subtitle1">Donaciones Totales Recibidas</Typography>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        >
          <div className="flex items-center mb-4">
            ...
            <Typography variant="h6" color="white" gutterBottom>
              Donaciones recibidas a lo largo del tiempo
            </Typography>
          </div>
